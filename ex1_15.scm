...
;the approximation sin(x) equals to x if x is sufficiently small, and the
;trigonometric identity sin(x) = 3sin(x/3) - 4sin^3(x/3) to reduce the size of
;the argument of sin. (For purpose of this exercise, an angle is considered
